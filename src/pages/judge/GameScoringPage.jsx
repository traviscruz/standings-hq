  ...
  const handleRecordTieBreaker = async (winnerName) => {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}/game/setup`, {
        ...
        body: JSON.stringify({ event_id: event.id, config: updatedConfig, created_by: userId })
      });
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                      ...
                      <div>
                        ...
                        <p style={{ fontSize: '13px', color: '#B45309', margin: '2px 0 0' }}>
                          {recordedWinner 
                            ? `The tie-breaker decision has been recorded in favor of ${recordedWinner}.` 
                          ...
                          <div key={roundNum} style={{
                            ...
                            {!rd.submitted ? (
                              isRoundNotRequired ? (
                                ...
                                <div style={{ display: 'flex', gap: '10px', marginBottom: '12px' }}>
                                  <button
                                    onClick={() => {
                                      if (!isLocked) setRoundWinner(activeMatch.id, roundNum, 'a');
                                    }}
                                    disabled={isLocked}
                                    style={{
                                      flex: 1,
                                  ...
                                  <button
                                    onClick={() => {
                                      if (!isLocked) setRoundWinner(activeMatch.id, roundNum, 'b');
                                    }}
                                    disabled={isLocked}
                                    style={{
                                      flex: 1,
                            ...
                            <div style={{ position: 'relative', marginBottom: '12px' }}>
                              ...
                              <input
                                ...
                                disabled={rd.submitted || isRoundNotRequired || isLocked}
                                value={rd.notes || ''}
                                ...
                                style={{
                                  ...
                                  fontSize: '12px',
                                  color: colors.navy,
                                  background: (rd.submitted || isRoundNotRequired || isLocked) ? '#F8FAFC' : '#fff',
                                  outline: 'none',
                                  boxSizing: 'border-box'
                                }}
                              />
                            ...
                            <div style={{ display: 'flex', gap: '8px' }}>
                              {!rd.submitted ? (
                                isRoundNotRequired ? (
                                  ...
                                  <button
                                    onClick={() => {
                                      if (!isLocked) setConfirmLock({ matchId: activeMatch.id, roundNum });
                                    }}
                                    disabled={rd.a == null || rd.b == null || isLocked}
                                    style={{
                                      width: '100%',
                                      height: '36px',
                                      borderRadius: '10px',
                                      ...
                                      fontSize: '12px',
                                      fontWeight: '700',
                                      cursor: (rd.a == null || rd.b == null || isLocked) ? 'not-allowed' : 'pointer',
                                      display: 'flex',
                                      alignItems: 'center',
                                      justifyContent: 'center',
                                      gap: '6px',
                                      opacity: (rd.a == null || rd.b == null || isLocked) ? 0.5 : 1,
                                      transition: 'all 0.2s'
                                    }}
                                    onMouseEnter={e => { if (rd.a != null && rd.b != null && !isLocked) e.currentTarget.style.background = colors.navySoft; }}
                                ...
                                <button
                                  onClick={() => {
                                    if (!isLocked) handleSaveRound(activeMatch.id, roundNum, false);
                                  }}
                                  disabled={isLocked}
                                  style={{
                                    width: '100%',
                                  ...
                                  onMouseEnter={e => {
                                    if (!isLocked) e.currentTarget.style.background = '#FEE2E2';
                                  }}
                                  onMouseLeave={e => {
